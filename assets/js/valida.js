	...
	$("#FormCadastro").validate(
	{
		...
		messages:
		{
			...
			NomeUsuario:
			{
				...
				minlength:"O nome de usuário deve possuir mais de 3 caracteres",
				maxlength:"O nome de usuário deve possuir menos de 45 caracteres",
			},

			Login:{
				required: "Informe o login",
				minlength:"O login de usuário deve possuir mais de 6 caracteres",
				maxlength:"O login de usuário deve possuir menos de 45 caracteres",
			},	

			password:{
				required: "Informe a senha",
				minlength:"O senha de usuário deve possuir mais de 6 caracteres",
				maxlength:"O senha de usuário deve possuir menos de 45 caracteres",
			},						
