	...
	public function createTable($tableName)
	{
		...
		"
			CREATE TABLE IF NOT EXISTS " . $tableName . " (
			  `IDN` int(4) NOT NULL AUTO_INCREMENT,
			  `MES` int(2) DEFAULT NULL,
			  `PAIS_ORIGEM` varchar(20) DEFAULT NULL,
			  `PAIS_AQUISICAO` varchar(20) DEFAULT NULL,
			  `UNIDADE_COMERCIALIZACAO` varchar(17) DEFAULT NULL,
			  `DESCRICAO_DETALHADA_PRODUTO` varchar(900) DEFAULT NULL,
			  `PESO_LIQUIDO_KG` decimal(10,5) DEFAULT NULL,
			  `VALOR_UNIDADE_PRODUTO_DOLAR` decimal(12,5) DEFAULT NULL,
			  `QUANTIDADE_COMERCIALIZADA_PRODUTO` decimal(7,5) DEFAULT NULL,
			  `VALOR_TOTAL_PRODUTO_DOLAR` decimal(13,7) DEFAULT NULL,
